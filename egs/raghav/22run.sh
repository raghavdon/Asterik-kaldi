...
steps/align_si.sh --nj "$train_nj" --cmd "$train_cmd" \
 --use-graphs true data/train data/lang exp/tri2_${sen}_${gauss} exp/tri2_${sen}_${gauss}_ali || exit 1;
...
steps/train_sat.sh --cmd "$train_cmd" \
 $sen $gauss data/train data/lang exp/tri2_${sen}_${gauss}_ali exp/tri3_${sen}_${gauss} || exit 1;
...
utils/mkgraph.sh data/lang_test exp/sgmm2_4_t2a exp/sgmm/graph || exit 1;

#utils/mkgraph.sh data/lang_test exp/sgmm2_4_t2a exp/sgmm2_4_t2a/graph || exit 1;
...
##   --transform-dir exp/tri3/decode_dev data/lang_test_bg 22hrdata/dev \
